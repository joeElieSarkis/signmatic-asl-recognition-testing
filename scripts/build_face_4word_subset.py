...
OUTPUT_PATH = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\face_4words\data")
...
def build_subset(split, max_samples):
    ...
    # keep only short full sentences
    ...
    np.save(OUTPUT_PATH / f"X_{split}_face_4w.npy", X)
    save_labels(OUTPUT_PATH / f"y_{split}_face_4w.txt", y)
    save_labels(OUTPUT_PATH / f"clip_names_{split}_face_4w.txt", clip_names)
